            ...
            <div class="col-md-3 col-lg-2 px-0 position-fixed sidebar">
                <div class="d-flex flex-column h-100">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link d-flex align-items-center" href="historique_reservations.php">
                            <i class="bi bi-clock-history me-2"></i>Historique
                        </a>
                        <a class="nav-link d-flex align-items-center" href="planning_enseignant.php">
                            <i class="bi bi-calendar3-week me-2"></i>Planning
                        </a>
                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text text-muted">Consultez et gérez vos réservations en cours et à venir.</p>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text text-muted">Réservez une salle pour vos cours ou réunions.</p>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text text-muted">Réservez le matériel nécessaire pour vos cours.</p>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm">
                                <div class="card-body text-center">
                                    <img src="/img/calendar-week.png" class="card-img-top" alt="Planning">
                                    <h5 class="card-title mt-3">Planning</h5>
                                    <p class="card-text text-muted">Consultez votre planning et gérez vos disponibilités.</p>
                                    <a href="planning_enseignant.php" class="btn btn-custom w-100">Voir</a>
                                </div>
                            </div>
                        </div>
                    </div>
