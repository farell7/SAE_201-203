...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        error_log("Tentative d'inscription : Nom=$nom, Prenom=$prenom, Pseudo=$pseudo, Email=$email, Postal=$postal, Date=$birthdate, Role=$role");
        ...
        echo "<script>
            alert('Une erreur est survenue lors de l\\'inscription : " . addslashes($e->getMessage()) . "');
            window.location.href = '../index.php';
        </script>";
        exit();
    }
